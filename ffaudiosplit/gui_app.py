...
"""
Name: gui_app.py
Porpose: bootstrap for FFaudiosplit app.
...
try:
    ...
    pass
from ffaudiosplit.ffc_sys.argparser import arguments
from ffaudiosplit.ffc_sys.settings_manager import DataSource  # data
from ffaudiosplit.ffc_sys import app_const as appC
from ffaudiosplit.ffc_utils.utils import del_filecontents
...
class CuesplitterGUI(wx.App):
    ...
    def OnInit(self):
        ...
        if self.check_ffmpeg():
            self.wizard(self.iconset['ffaudiosplit'])
            return True

        from ffaudiosplit.ffc_main.main_frame import MainFrame
    ...
    def wizard(self, wizardicon):
        ...
        """
        from ffaudiosplit.ffc_dlg.wizard_dlg import Wizard
