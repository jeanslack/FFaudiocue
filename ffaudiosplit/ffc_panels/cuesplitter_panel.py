...
from ffaudiosplit.ffc_utils.utils import get_codec_quality_items
from ffaudiosplit.ffc_threads.ffmpeg_processing import Processing
from ffaudiosplit.ffc_dlg.widget_utils import notification_area
from ffaudiosplit.ffc_utils.utils import move_files_to_outputdir


class CueGui(wx.Panel):
    """
    Represents the only one main panel for FFaudiosplit
    ...
    def update_attributes_of_ffcuesplitter_api(self):
        ...
        if self.ckbx_codec_copy.IsChecked():
            ...
            if src in ('.flac', '.FLAC'):
                wx.MessageBox(f'{msg}', "FFaudiosplit- Information",
    ...
    def update_count_items(self, msg, end):
        ...
        if end == 'error':
            self.error = True
            wx.MessageBox(f'{msg}', "FFaudiosplit", wx.ICON_ERROR, self)
        else:
            ...
            if self.ckbx_removesrc.IsChecked():
                ...
                if dlg == wx.ID_YES:
                    ...
                    if ret is False:
                        ...
                        wx.MessageBox(msg, "FFaudiosplit - Error",
                                      wx.ICON_ERROR, self)
