...
"""
Name: argparser.py
Porpose: FFaudiosplit Command line arguments
...
import argparse
import platform
from ffaudiosplit.ffc_sys.about_app import (PRGNAME,
                                                 VERSION,
                                                 RELSTATE
                                                 )
try:
...
def arguments():
    ...
    parser.add_argument('-c', '--check',
                        help=('List of executables used by FFaudiosplit '
                              'found on the system'),
                        action="store_true",
                        )
    ...
    if argmts.check:
        ...
        print('\nList of executables used by FFaudiosplit:')
        for key, val in deps.items():
