...
import requests
import wx
from ffaudiosplit.ffc_utils.utils import open_default_application
...
def openpath(where):
    ...
    if ret:
        wx.MessageBox(ret, _('FFaudiosplit - Error!'),
                      wx.ICON_ERROR, None)
# -------------------------------------------------------------------------#
...
def get_github_releases(url, keyname):
    ...
    <https://api.github.com/repos/jeanslack/FFaudiosplit/releases>
